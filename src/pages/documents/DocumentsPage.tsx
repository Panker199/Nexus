                ...
                {documents.map(doc => (
                  <div key={doc.id} className="flex items-center p-3 hover:bg-gray-50 rounded-xl transition-colors group">
                    ...
                    <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Button variant="ghost" size="xs" className="p-2" aria-label="Download"><Download size={16} /></Button>
                      <Button variant="ghost" size="xs" className="p-2" aria-label="Share"><Share2 size={16} /></Button>
                      <Button variant="ghost" size="xs" className="p-2 text-error-500 hover:text-error-700" aria-label="Delete"><Trash2 size={16} /></Button>
                    </div>
                  </div>
                ))}
              </div>
